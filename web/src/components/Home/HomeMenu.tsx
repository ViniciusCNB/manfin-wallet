  ...
  return (
    <div className="relative">
      <img
        ...
        alt=""
      />
      <div className="bg-gradient-to-r from-[#033959]/95 to-[#01141f]/95 w-[100%] h-screen py-8 px-10 flex flex-col gap-20 items-center justify-center shadow-md shadow-slate-800/20 border-solid border-b-[1px] relative z-1">
        {" "}
        <span className="text-white text-[7.5rem] border-b-2">
          ManFin Wallet
        </span>
        ...
        <p className="text-white flex text-center font-thin text-[1.1rem] mt-5 w-2/5">
          Desenvolvido por Vinícius Correa Nobre Borges, graduando do 8º período
          ...
          <br />
          Já a outra foi desenvolvida com o intuito de ser um gestor de gastos
          pessoais.
          <br />
